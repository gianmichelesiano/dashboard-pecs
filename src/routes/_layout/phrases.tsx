...
import PhraseCollections from "../../components/Phrases/PhraseCollections";
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr>
              ...
              <th style={{ padding: '8px', textAlign: 'left' }}>Collezioni</th>
            ...
            {phrases.map((phrase) => {
              ...
              return (
                <tr key={phrase.id} style={{ opacity: isPlaceholderData ? 0.5 : 1 }}>
                  ...
                  <td style={{ padding: '8px' }}>
                    <PhraseCollections phraseId={phrase.id} />
                  </td>
                  <td style={{ padding: '8px' }}>
